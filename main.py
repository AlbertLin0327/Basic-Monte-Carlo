...
def main():
	...
	print('Enter: spot price, time interval, interest(%), dividend(%), volatility(%), period, stimulations')

	while True:
		try:
			spot, time, interest, dividend, volatility, period, simulations = map(float, input().split())
			break
